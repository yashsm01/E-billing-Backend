...
module.exports = (sequelize, DataTypes) => {
  const customer_product_p = sequelize.define('customer_product_p', {
  ...
  customer_product_p.associate = function (models) {
    // associations can be defined here
  };
  customer_product_p.sync({ alter: false })
  return customer_product_p;
};
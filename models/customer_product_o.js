...
module.exports = (sequelize, DataTypes) => {
  const customer_product_o = sequelize.define('customer_product_o', {
  ...
  customer_product_o.associate = function (models) {
    // associations can be defined here
  };
  customer_product_o.sync({ alter: false })
  return customer_product_o;
};
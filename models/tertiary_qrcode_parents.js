...
module.exports = (sequelize, DataTypes) => {
  const tertiary_qrcode_parents = sequelize.define('tertiary_qrcode_parents', {
  ...
  tertiary_qrcode_parents.associate = function (models) {
    // associations can be defined here
    tertiary_qrcode_parents.hasOne(models.products, {
      foreignKey: 'id',
      sourceKey: 'product_id'
    })
    tertiary_qrcode_parents.hasOne(models.locations, {
      foreignKey: 'id',
      sourceKey: 'location_id'
    })
    tertiary_qrcode_parents.hasOne(models.production_orders, {
      foreignKey: 'id',
      sourceKey: 'po_id'
    })
    tertiary_qrcode_parents.hasOne(models.product_batches, {
      foreignKey: 'id',
      sourceKey: 'batch_id'
    })
    tertiary_qrcode_parents.hasOne(models.company_users, {
      foreignKey: 'id',
      sourceKey: 'created_by'
    })
  };
  tertiary_qrcode_parents.sync({ alter: false })
  return tertiary_qrcode_parents;
};

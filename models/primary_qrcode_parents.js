...
module.exports = (sequelize, DataTypes) => {
  const primary_qrcode_parents = sequelize.define('primary_qrcode_parents', {
  ...
  primary_qrcode_parents.associate = function (models) {
    // associations can be defined here
    primary_qrcode_parents.hasOne(models.products, {
      foreignKey: 'id',
      sourceKey: 'product_id'
    })
    primary_qrcode_parents.hasOne(models.locations, {
      foreignKey: 'id',
      sourceKey: 'location_id'
    })
    primary_qrcode_parents.hasOne(models.production_orders, {
      foreignKey: 'id',
      sourceKey: 'po_id'
    })
    primary_qrcode_parents.hasOne(models.product_batches, {
      foreignKey: 'id',
      sourceKey: 'batch_id'
    })
    primary_qrcode_parents.hasOne(models.company_users, {
      foreignKey: 'id',
      sourceKey: 'created_by'
    })
  };
  primary_qrcode_parents.sync({ alter: false })
  return primary_qrcode_parents;
};

...
module.exports = (sequelize, DataTypes) => {
  const outer_qrcode_parents = sequelize.define('outer_qrcode_parents', {
  ...
  outer_qrcode_parents.associate = function (models) {
    // associations can be defined here
    outer_qrcode_parents.hasOne(models.products, {
      foreignKey: 'id',
      sourceKey: 'product_id'
    })
    outer_qrcode_parents.hasOne(models.locations, {
      foreignKey: 'id',
      sourceKey: 'location_id'
    })
    outer_qrcode_parents.hasOne(models.production_orders, {
      foreignKey: 'id',
      sourceKey: 'po_id'
    })
    outer_qrcode_parents.hasOne(models.product_batches, {
      foreignKey: 'id',
      sourceKey: 'batch_id'
    })
    outer_qrcode_parents.hasOne(models.company_users, {
      foreignKey: 'id',
      sourceKey: 'created_by'
    })
  };
  outer_qrcode_parents.sync({ alter: false })
  return outer_qrcode_parents;
};

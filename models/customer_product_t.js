...
module.exports = (sequelize, DataTypes) => {
  const customer_product_t = sequelize.define('customer_product_t', {
  ...
  customer_product_t.associate = function (models) {
    // associations can be defined here
  };
  customer_product_t.sync({ alter: false })
  return customer_product_t;
};